...
class CoreContractTests(unittest.TestCase):
    ...
    def test_mcp_lists_seventeen_tools_without_provider_call(self):
        ...
        self.assertTrue({"jev_setup", "jev_route", "jev_recipe_catalog", "jev_recipe_try", "jev_review_diff"} <= names)
