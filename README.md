...
<p align="center">
<a href="https://github.com/qualixar/jev-decision-layer/releases/tag/v1.0.6"><img src="https://img.shields.io/badge/version-1.0.6-2fd3b3?style=flat-square" alt="Version 1.0.6"></a>
...
**Current release: 1.0.6** — 20 MCP tools, 36 recipes, 108 offline fixtures, five host adapters. See the [changelog](CHANGELOG.md).
...
```sh
claude mcp add qualixar-jev -- "$HOME/.claude/plugins/cache/qualixar/qualixar-jev-decision-layer/1.0.6/scripts/launch-jev"
```
