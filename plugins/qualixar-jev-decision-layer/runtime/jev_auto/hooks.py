    ...
    try:
        if name == "SessionStart":
            ...
            return {
                "hookSpecificOutput": {
                    "hookEventName": name,
                    "additionalContext": "Qualixar Jev Decision Layer 1.0.5 is enrolled here. Eligible decisions use the standing budget; do not request per-turn grants. Preserve SLM and the existing Computer Use skill.",
                }
            }
