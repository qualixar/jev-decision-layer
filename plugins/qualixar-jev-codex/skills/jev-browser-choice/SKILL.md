...
description: Use Jev selectively to choose among safe, observed controls in an authorized host browser tab; works with the current native browser interface without a separate browser runtime.
---

# Selective browser choice

Use the host's available native browser or Computer Use interface to observe the live tab. The user and host authorize browser access; this skill grants no new permission. Never pass cookies, credentials, hidden fields, full-page dumps, screenshots, or account details to Jev.
